      ...
      <main className="px-6 sm:px-12 py-12 bg-white">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
            ...
            <div className="p-0 rounded-lg shadow-lg bg-white hover:shadow-2xl hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-4">
                <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900">Our Team</h3>
            ...
            <div className="p-0 rounded-lg shadow-lg bg-white hover:shadow-2xl hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-4">
                <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900">Our Services</h3>
                <p className="text-gray-600">
            ...
            <div className="p-0 rounded-lg shadow-lg bg-white hover:shadow-2xl hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-4">
                <h3 className="text-xl font-bold mt-4 mb-2 text-gray-900">Our Process</h3>
                <p className="text-gray-600">
        ...
        <section id="clients" className="py-12 text-center">
          ...
          <div className="flex justify-center gap-8 bg-white p-6 rounded-lg shadow-lg m-auto max-w-4xl">
            <Image src="/acc-logo.jpg" alt="Client 1" width={100} height={50} />
            <Image src="/jbs-logo.png" alt="Client 2" width={100} height={50} />
            <Image src="/rpf-logo.avif" alt="Client 3" width={100} height={50} />
          </div>
        </section>
