                ...
                <section className="space-y-12">
                    ...
                    <div className="space-y-12 bg-[var(--background-alt)] py-16 px-6 sm:px-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 text-center sm:text-left border-b border-[var(--muted)] pb-6 mb-8">
                            <h2 className="text-4xl font-bold text-[var(--text)]">JBS Foods Australia</h2>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="p-6 bg-[var(--foreground)] shadow-md rounded-lg l flex flex-col w-full">
                                ...
                                <p className="text-lg leading-relaxed text-[var(--text)] flex-grow mb-4">
                                    LT Controls engineered a very unique world’s first new automatic grading and sorting system for a leading global food company JBS beef Foods with operations in the United States, Australia, Canada, Europe, Mexico, New Zealand and the UK...
                                </p>
                                <p className="italic text-[var(--muted)]">Duration: Two-year project</p>
                            </div>
                            ...
                            <div className="p-6 bg-[var(--foreground)] shadow-md rounded-lg transition-shadow flex flex-col w-full">
                                ...
                                <p className="text-lg leading-relaxed text-[var(--text)] flex-grow mb-4">
                                    LT was approached to perform an upgrade of the JBS Kill Floor PLC program from SLC to an Allen Bradley Control Logix. This program included converting 15 IO racks consisting of DHRIO and Device Net...
                                </p>
                                <p className="italic text-[var(--muted)]">Duration: Six months</p>
                            </div>
                    ...
                    <div className="space-y-12 bg-[var(--background)] py-16 px-6 sm:px-12">
                        {/* Header Section */}
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 text-center sm:text-left border-b border-[var(--muted)] pb-6 mb-8">
                            <h2 className="text-4xl font-bold text-[var(--text)]">Australian Country Choice</h2>
                            <div className="flex-grow flex justify-center sm:justify-end mt-4 sm:mt-0">
                                <img
                                    src="/acc-logo.jpg"
                    ...
                    <div className="space-y-12 bg-[var(--background-alt)] py-16 px-6 sm:px-12">
                        {/* Header Section */}
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 text-center sm:text-left border-b border-[var(--muted)] pb-6 mb-8">
                            <h2 className="text-4xl font-bold text-[var(--text)]">Real Pet Food Co</h2>
                            <div className="flex-grow flex justify-center sm:justify-end mt-4 sm:mt-0">
                                <img
                                    src="/rpf-logo.avif"
                        ...
                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="p-6 bg-[var(--foreground)] shadow-md rounded-lg flex flex-col w-full">
                                ...
                                <p className="italic text-[var(--muted)]">Duration: Twelve months</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-12 bg-[var(--background)] py-16 px-6 sm:px-12">
                        {/* Header Section */}
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 text-center sm:text-left border-b border-[var(--muted)] pb-6 mb-8">
                            <h2 className="text-4xl font-bold text-[var(--text)]">Norco Milk</h2>
                            <div className="flex-grow flex justify-center sm:justify-end mt-4 sm:mt-0">
                                <img
                                    src="/norco-logo.jpg"
                                    alt="Norco Milk Logo"
                    ...
                    <div className="space-y-12 bg-[var(--background-alt)] py-16 px-6 sm:px-12">
                        {/* Header Section */}
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 text-center sm:text-left border-b border-[var(--muted)] pb-6 mb-8">
                            <h2 className="text-4xl font-bold text-[var(--text)]">Grove Juice</h2>
                            <div className="flex-grow flex justify-center sm:justify-end mt-4 sm:mt-0">
                                <img
                                    src="/grove-logo.svg"
